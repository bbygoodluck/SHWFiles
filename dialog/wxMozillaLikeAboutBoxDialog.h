...
#define SYMBOL_WXMOZILLALIKEABOUTBOXDIALOG_STYLE wxCAPTION | wxTAB_TRAVERSAL// | wxSYSTEM_MENU | wxCLOSE_BOX
...
#define SYMBOL_WXMOZILLALIKEABOUTBOXDIALOG_SIZE wxSize(400, 200)
